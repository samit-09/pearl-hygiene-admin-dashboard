...
const CleaningSectors: React.FC = () => {
  ...
  const deleteCleaningSector = async (sectorId: string) => {
    ...
    if (result.isConfirmed) {
      const sectorRef = ref(database, `cleaning-sectors/${sectorId}`);
      ...
      try {
        ...
        Swal.fire(
          "Deleted!",
          "The cleaning sector has been deleted.",
          "success",
        );
      } catch (error) {
        Swal.fire(
          "Error!",
          "Failed to delete cleaning sector. Please try again later.",
          "error",
        );
    ...
    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
      ...
      <div className="grid grid-cols-6 border-t border-stroke px-4 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
        ...
        <div className="col-span-2 hidden items-center sm:flex">
          <p className="text-lg font-medium">Sector Name</p>
        </div>
      ...
      {sectors.map((sector, key) => (
        ...
        >
          ...
          <div className="col-span-2 hidden items-center sm:flex">
            <p className="text-lg text-black dark:text-white">{sector.id}</p>
          </div>
          <div className="col-span-1 flex items-center">
            <p className="border-b border-[#eee] py-5 dark:border-strokedark">
              <div className="flex items-center space-x-3.5">
                {/* <Link href={`https://pearl-hygiene.vercel.app/sectors/${sector.id}`} className="hover:text-primary">
                  <svg
                ...
                <button
                  onClick={() => deleteCleaningSector(sector.id)}
